...
public:
    void solveOne(istream& in, ostream& out) {
      Point<double> p, q, r, s;
      in >> p >> q >> r >> s;
      Segment<double> s1(p, q, 1), s2(r, s, 1);
      Point<double> res;
      auto type = s1.intercept(s2, res);
      if (type == 0) out << "NONE" << '\n';
      else if (type == 1) out << "POINT " << res << '\n';
      else out << "LINE" << '\n';
    }
